...
class YOLOV5_ONNX(object):
    def __init__(self, onnx_path, img_size=(640, 1088), iou_threshold=0.5, conf_threshold=0.4):
        """初始化onnx"""
    ...
    def plot_one_box(self, x, img, color=None, label=None, line_thickness=None, style="line"):
